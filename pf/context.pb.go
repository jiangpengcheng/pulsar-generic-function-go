...
var file_context_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x1c, 0x0a, 0x08, 0x53, 0x74, 0x61, 0x74, 0x65, 0x4b, 0x65,
...
var file_context_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_context_proto_goTypes = []interface{}{
	(*StateKey)(nil),      // 0: context.StateKey
	(*StateKeyValue)(nil), // 1: context.StateKeyValue
	(*StateResult)(nil),   // 2: context.StateResult
	(*IncrStateKey)(nil),  // 3: context.IncrStateKey
	(*Counter)(nil),       // 4: context.Counter
	(*Request)(nil),       // 5: context.Request
	(*MessageId)(nil),     // 6: context.MessageId
	(*PulsarMessage)(nil), // 7: context.PulsarMessage
	(*Record)(nil),        // 8: context.Record
	(*MetricData)(nil),    // 9: context.MetricData
	(*Partition)(nil),     // 10: context.Partition
	(*emptypb.Empty)(nil), // 11: google.protobuf.Empty
}
var file_context_proto_depIdxs = []int32{
	7,  // 0: context.ContextService.publish:input_type -> context.PulsarMessage
	6,  // 1: context.ContextService.currentRecord:input_type -> context.MessageId
	9,  // 2: context.ContextService.recordMetrics:input_type -> context.MetricData
	10, // 3: context.ContextService.seek:input_type -> context.Partition
	10, // 4: context.ContextService.pause:input_type -> context.Partition
	10, // 5: context.ContextService.resume:input_type -> context.Partition
	0,  // 6: context.ContextService.getState:input_type -> context.StateKey
	1,  // 7: context.ContextService.putState:input_type -> context.StateKeyValue
	0,  // 8: context.ContextService.deleteState:input_type -> context.StateKey
	0,  // 9: context.ContextService.getCounter:input_type -> context.StateKey
	3,  // 10: context.ContextService.incrCounter:input_type -> context.IncrStateKey
	11, // 11: context.ContextService.publish:output_type -> google.protobuf.Empty
	8,  // 12: context.ContextService.currentRecord:output_type -> context.Record
	11, // 13: context.ContextService.recordMetrics:output_type -> google.protobuf.Empty
	11, // 14: context.ContextService.seek:output_type -> google.protobuf.Empty
	11, // 15: context.ContextService.pause:output_type -> google.protobuf.Empty
	11, // 16: context.ContextService.resume:output_type -> google.protobuf.Empty
	2,  // 17: context.ContextService.getState:output_type -> context.StateResult
	11, // 18: context.ContextService.putState:output_type -> google.protobuf.Empty
	11, // 19: context.ContextService.deleteState:output_type -> google.protobuf.Empty
	4,  // 20: context.ContextService.getCounter:output_type -> context.Counter
	11, // 21: context.ContextService.incrCounter:output_type -> google.protobuf.Empty
